KManager.action :bootstrap do
  action do
    application_name = :kweb03_bootstrap
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Sample Rails 7 application using bootstrap 5',
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 '',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/kweb03-bootstrap'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'kweb03-bootstrap'
